  ...
  return (
    <section id="odoo-lab" className="border-t border-ink-800 bg-ink-850/30 py-28">
      <div className="mx-auto max-w-content px-6">
          ...
          Self-Directed Internal POC Initiative
        </p>
        <h2 className="mt-3 max-w-2xl text-balance font-display text-4xl font-medium text-ink-50 md:text-5xl">
          Odoo AI & ERP Innovation Lab
        </h2>
        <p className="mt-4 max-w-xl text-ink-300">
          Internal learning and POC initiative exploring how AI, analytics and automation can
          enhance Odoo business workflows across CRM, Helpdesk, Inventory, Integration,
          Manufacturing and Procurement. Self-directed — not client work.
        </p>
